...
Set the working directory to the location of this `.Rmd` file. 
```{r}
# This is synced with the online GitHub repository through GitHub Desktop.
setwd("/Users/djparker/Documents/GitHub/Predictive-Modeling-Cat-Dog/doc")
```

Specify directories for the raw image training and test data. These cannot be included in the GitHub respository because the data are too large.
```{r}
project_dir <- "/Users/djparker/Documents/Temp/Juilliard/Spring\ 2018/ADS_STAT_4243/Project_2/"
img_train_dir  <- paste(project_dir, "train/", sep="")
img_test_dir   <- paste(project_dir, "test/", sep="")
```

Specify directories for professor-provided SIFT features. These are also too large for the GitHub repository.
```{r}
